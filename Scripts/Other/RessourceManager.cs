...
public class RessourceManager : MonoBehaviour
{
    ...
    public double total_eau = 100;
    public double total_alim = 100;
    public double total_bois = 100;
